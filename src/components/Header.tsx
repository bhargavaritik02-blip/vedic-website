...
export default function Header({ activePage }: HeaderProps) {
  ...
  const navLinks = [
    ...
    { name: 'Jaipur Solution', path: '/love-problem-solution-jaipur', id: 'jaipur-love' },
    { name: 'Mumbai Solution', path: '/love-problem-solution-mumbai', id: 'mumbai-love' },
    { name: 'Lost Love India', path: '/lost-love-back-india', id: 'india-love' },
      ...
      <div className="max-w-[1440px] mx-auto px-4 lg:px-6 py-4 flex items-center justify-between relative z-50">
        ...
        <Link to="/" className="flex items-center gap-3 shrink-0">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[10px] text-orange-500 uppercase tracking-widest font-semibold hidden sm:block">Love & Relationship Healer ❤️</span>
          </div>
        </Link>
