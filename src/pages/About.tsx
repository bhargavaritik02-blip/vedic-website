...
import { Phone, Star, Award, ShieldCheck, Heart, User, CheckCircle } from 'lucide-react';
    ...
    <div className="bg-[#050505] min-h-screen text-zinc-200 font-sans">
      ...
      <main className="max-w-[1440px] mx-auto px-4 sm:px-6 flex flex-col gap-12 py-10 pb-24 md:pb-10">
          ...
          <div className="max-w-6xl mx-auto relative z-10 flex flex-col lg:flex-row items-center gap-12">
            <div className="w-full lg:w-5/12 flex justify-center">
              <div className="relative inline-block">
                ...
                <img 
                  src="https://i.ibb.co/TBCRvsGx/PHOTO-2026-03-18-11-58-44.jpg" 
                  alt="Astrologer Mannu Shastri" 
                  loading="lazy"
                  className="relative z-10 w-64 h-64 md:w-80 md:h-80 object-cover rounded-full border-4 border-orange-500/30 shadow-[0_0_40px_rgba(249,115,22,0.15)] brightness-[0.85] contrast-[1.05] saturate-[1.1]"
                />
              </div>
            </div>
            ...
            <div className="w-full lg:w-7/12 text-center lg:text-left">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif text-white font-bold leading-tight mb-6">
                ...
                <span className="text-orange-500">Astrologer Mannu Shastri</span>
              </h1>
              
              <div className="text-lg text-zinc-400 space-y-5 leading-relaxed">
                <p>
                  Every relationship has its ups and downs. Many people go through emotional pain, misunderstandings, and situations where they feel lost and helpless. I started this journey with one simple goal — to help people find clarity, rebuild their relationships, and bring genuine happiness back into their lives.
                </p>
                <p>
                  Over time, I realized that most people don’t just need a quick fix — they need a real human being who listens without judgment, understands their deepest emotional pain, and guides them with patience and sincerity. That is exactly what I dedicate my life to.
                </p>
                <p>
                  With years of dedicated practice and a profound understanding of love and relationship dynamics, I have successfully guided over <strong className="text-orange-500 font-bold">55,000+ individuals</strong> who were struggling with painful breakups, lost love, and emotional distress.
                </p>
                <p>
                  I believe in complete transparency, keeping things 100% confidential, and offering practical, effective solutions. My goal is not just to give advice, but to walk with you through the tough times and help you move forward with confidence and peace of mind.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto w-full">
          <div className="bg-zinc-900/40 border border-zinc-800 rounded-[2rem] p-8 md:p-12">
        ...
        <section className="py-10 max-w-6xl mx-auto w-full">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-serif text-white mb-4">Real Client <span className="text-orange-500">Experiences</span></h2>
        ...
        <section className="bg-gradient-to-r from-orange-600 to-amber-600 rounded-[2rem] p-8 sm:p-10 md:p-16 text-center text-white relative overflow-hidden max-w-6xl mx-auto w-full">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <a href="https://wa.me/919928433259" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto bg-white text-orange-600 hover:bg-zinc-100 font-bold py-4 px-8 rounded-xl flex items-center justify-center gap-3 transition-colors shadow-xl text-lg group">
                <WhatsappIcon className="w-6 h-6 text-[#25D366] group-hover:animate-[bounce_1s_infinite]" /> Chat on WhatsApp
              </a>
              <a href="tel:+919928433259" className="w-full sm:w-auto bg-black/20 hover:bg-black/30 border border-white/30 text-white font-bold py-4 px-8 rounded-xl flex items-center justify-center gap-3 transition-colors text-lg group">
                <Phone className="w-6 h-6 group-hover:animate-[bounce_1s_infinite]" /> Call Now
              </a>
            </div>
          </div>
        </section>
