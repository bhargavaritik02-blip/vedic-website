...
import { Phone, HeartPulse, ShieldCheck, Users, HeartCrack, Star } from 'lucide-react';
      ...
      <main className="max-w-[1440px] mx-auto px-4 sm:px-6 flex flex-col gap-12 py-10 pb-24 md:pb-10">
        ...
        <section className="relative overflow-hidden rounded-[2rem] bg-gradient-to-b from-zinc-900 to-black border border-zinc-800 text-center py-12 px-6 sm:py-16 md:py-24">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 relative z-10">
            <a href="https://wa.me/919928433259?text=I%20need%20love%20problem%20solution%20in%20Mumbai" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto bg-[#25D366] text-white hover:bg-[#20bd5a] font-bold py-4 px-8 rounded-xl flex items-center justify-center gap-3 transition-colors shadow-lg shadow-[#25D366]/20 transform hover:scale-105 group">
        ...
        <section className="bg-zinc-900/40 border border-zinc-800 rounded-[2rem] p-6 sm:p-8 md:p-14 flex flex-col md:flex-row gap-8 items-center">
          <div className="md:w-1/2">
            <h2 className="text-3xl md:text-4xl font-serif text-white mb-6">Best Astrologer for Love Problem in <span className="text-orange-500">Mumbai</span></h2>
        ...
        <section className="bg-gradient-to-r from-orange-600 to-amber-600 rounded-[2rem] p-8 sm:p-10 md:p-16 text-center text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <a href="https://wa.me/919928433259?text=I%20need%20love%20problem%20solution" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto bg-white text-orange-600 hover:bg-zinc-100 font-bold py-4 px-8 rounded-xl flex items-center justify-center gap-3 transition-colors shadow-xl group">
